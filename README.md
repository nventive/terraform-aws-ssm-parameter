...
| <a name="input_policy_enabled"></a> [policy\_enabled](#input\_policy\_enabled) | Set to false to prevent the module from creating an IAM policy | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the SSM parameter. |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether or not the module is enabled. |
